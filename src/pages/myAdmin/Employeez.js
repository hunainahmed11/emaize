          ...
          <div className="row staff-grid-row">
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">John Doe</Link>
                </h4>
            ...
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">Richard Miles</Link>
                </h4>
            ...
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">John Smith</Link>
                </h4>
            ...
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">Mike Litorus</Link>
                </h4>
            ...
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">Wilmer Deluna</Link>
                </h4>
            ...
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">Jeffrey Warden</Link>
                </h4>
                <div className="small text-muted">Web Developer</div>
              </div>
            </div>
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">Bernardo Galaviz</Link>
                </h4>
                <div className="small text-muted">Web Developer</div>
              </div>
            </div>
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">Lesley Grauer</Link>
                </h4>
                <div className="small text-muted">Team Leader</div>
              </div>
            </div>
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">Jeffery Lalor</Link>
                </h4>
                <div className="small text-muted">Team Leader</div>
              </div>
            </div>
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">Loren Gatlin</Link>
                </h4>
                <div className="small text-muted">Android Developer</div>
              </div>
            </div>
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">Tarah Shropshire</Link>
                </h4>
                <div className="small text-muted">Android Developer</div>
              </div>
            </div>
            <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
              <div className="profile-widget">
                ...
                <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                  <Link to="/Profilee">Catherine Manseau</Link>
                </h4>
                <div className="small text-muted">Android Developer</div>
              </div>
            </div>
