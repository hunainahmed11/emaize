          ...
          <ul>
            ...
            <li className="submenu">
              ...
              <ul style={{ display: "none" }}>
                ...
                <li>
                  <a className="active" href="leaves.html">
                    Leaves (Admin){" "}
                ...
                <tbody>
                  ...
                  <tr>
                    <td>
                      <h2 className="table-avatar">
                        <a href="profile.html" className="avatar">
                          <img alt="" src="assets/img/profiles/avatar-24.jpg" />
                        </a>
                        <a>
                  ...
                  <tr>
                    <td>
                      <h2 className="table-avatar">
                        <a href="profile.html" className="avatar">
                          <img alt="" src="assets/img/profiles/avatar-15.jpg" />
                        </a>
                        <a>
                  ...
                  <tr>
                    <td>
                      <h2 className="table-avatar">
                        <a href="profile.html" className="avatar">
                          <img alt="" src="assets/img/profiles/avatar-20.jpg" />
                        </a>
                        <a>
                  ...
                  <tr>
                    <td>
                      <h2 className="table-avatar">
                        <a href="profile.html" className="avatar">
                          <img alt="" src="assets/img/profiles/avatar-25.jpg" />
                        </a>
                        <a>
