             ...
             <div className="row align-items-center">
               ...
               <div className="col-auto float-right ml-auto">
                 ...
                 <div className="view-icons">
                   ...
                   <Link to="/ClientsList" className="list-view btn btn-link">
                     <i className="fa fa-bars" />
                   </Link>
                 </div>
               </div>
           ...
           <div className="row staff-grid-row">
             <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
               <div className="profile-widget">
                 ...
                 <h5 className="user-name m-t-10 mb-0 text-ellipsis">
                   <Link to="/ClientProfile">Barry Cuda</Link>
                 </h5>
                 <div className="small text-muted">CEO</div>
                 <Link to="/Chat" className="btn btn-white btn-sm m-t-10">
                   Message
                 </Link>
             ...
             <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
               <div className="profile-widget">
                 ...
                 <h5 className="user-name m-t-10 mb-0 text-ellipsis">
                   <Link to="/ClientProfile">Tressa Wexler</Link>
                 </h5>
             ...
             <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
               <div className="profile-widget">
                 ...
                 <h5 className="user-name m-t-10 mb-0 text-ellipsis">
                   <Link to="/ClientProfile">Ruby Bartlett</Link>
                 </h5>
                 <div className="small text-muted">CEO</div>
                 <a href="chat.html" className="btn btn-white btn-sm m-t-10">
                   Message
                 </a>
                 <Link to="/ClientProfile"
                   className="btn btn-white btn-sm m-t-10"
             ...
             <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
               <div className="profile-widget">
                 ...
                 <h5 className="user-name m-t-10 mb-0 text-ellipsis">
                   <Link to="/ClientProfile">Misty Tison</Link>
                 </h5>
                 <div className="small text-muted">CEO</div>
                 <Link to="/Chat" className="btn btn-white btn-sm m-t-10">
                   Message
             ...
             <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
               <div className="profile-widget">
                 ...
                 <h5 className="user-name m-t-10 mb-0 text-ellipsis">
                   <Link to="/ClientProfile">Daniel Deacon</Link>
                 </h5>
                 <div className="small text-muted">CEO</div>
                 <Link to="/Chat" className="btn btn-white btn-sm m-t-10">
                   Message
             ...
             <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
               <div className="profile-widget">
                 ...
                 <h4 className="user-name m-t-10 mb-0 text-ellipsis">
                   <Link to="/ClientProfile">International Software Inc</Link>
                 </h4>
                 <h5 className="user-name m-t-10 mb-0 text-ellipsis">
                   <Link to="/ClientProfile">Walter Weaver</Link>
                 </h5>
                 <div className="small text-muted">CEO</div>
                 <Link to="/Chat" className="btn btn-white btn-sm m-t-10">
                   Message
             ...
             <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
               <div className="profile-widget">
                 ...
                 <h5 className="user-name m-t-10 mb-0 text-ellipsis">
                   <Link to="/ClientProfile">Amanda Warren</Link>
                 </h5>
                 <div className="small text-muted">CEO</div>
                 <Link to="/Chat" className="btn btn-white btn-sm m-t-10">
                   Message
             ...
             <div className="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
               <div className="profile-widget">
                 ...
                 <h5 className="user-name m-t-10 mb-0 text-ellipsis">
                   <Link to="/ClientProfile">Betty Carlson</Link>
                 </h5>
                 <div className="small text-muted">CEO</div>
                 <Link to="/Chat" className="btn btn-white btn-sm m-t-10">
                   Message
