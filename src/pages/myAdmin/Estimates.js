           ...
           <div className="page-header">
             <div className="row align-items-center">
               ...
               <div className="col-auto float-right ml-auto">
                 <Link to="/CreateEstimate" className="btn add-btn">
               ...
               <div className="table-responsive">
                 <table className="table table-striped custom-table mb-0">
                   ...
                   <tbody>
                     <tr>
                       <td>
                         <Link to="/EstimateView">EST-0001</Link>
                       </td>
                     ...
                     <tr>
                       <td>
                         <Link to="/EstimateView">EST-0002</Link>
                       </td>
                     ...
                     <tr>
                       <td>
                         <Link to="/EstimateView">EST-0003</Link>
                       </td>
                       <td>Cream Inc</td>
                       <td>11 Mar 2019</td>
                       <td>17 Mar 2019</td>
                     ...
                     <tr>
                       <td>
                         <Link to="/EstimateView">EST-0004</Link>
                       </td>
