           ...
           <div id="sidebar-menu" className="sidebar-menu">
             <ul>
               ...
               <li className="submenu">
                 ...
                 <ul style={{ display: "none" }}>
                   <li>
                     <a className="active" href="estimates.html">
                       Estimates
                     </a>
                   </li>
                   <li>
           ...
           <div className="page-header">
             <div className="row align-items-center">
               ...
               <div className="col-auto float-right ml-auto">
                 <a href="create-estimate.html" className="btn add-btn">
               ...
               <div className="table-responsive">
                 <table className="table table-striped custom-table mb-0">
                   ...
                   <tbody>
                     ...
                     <tr>
                       <td>
                         <a href="estimate-view.html">EST-0002</a>
                       </td>
                     ...
                     <tr>
                       <td>
                         <a href="estimate-view.html">EST-0003</a>
                       </td>
                       <td>Cream Inc</td>
                       <td>11 Mar 2019</td>
                       <td>17 Mar 2019</td>
                     ...
                     <tr>
                       <td>
                         <a href="estimate-view.html">EST-0004</a>
                       </td>
