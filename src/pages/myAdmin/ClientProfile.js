                         ...
                         <div className="col-md-5">
                           <div className="profile-info-left">
                             ...
                             <div className="staff-msg">
                               <Link to="/Chat" className="btn btn-custom">
                                 Send Message
                               </Link>
                             </div>
                           </div>
                       ...
                       <div className="card">
                         <div className="card-body">
                           ...
                           <h4 className="project-title">
                             <Link to="/ProjectView">Office Management</Link>
                           </h4>
                     ...
                     <div className="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                       <div className="card">
                         <div className="card-body">
                           ...
                           <h4 className="project-title">
                             <Link to="/ProjectView">Project Management</Link>
                           </h4>
                           <small className="block text-ellipsis m-b-15">
                     ...
                     <div className="col-lg-4 col-sm-6 col-md-4 col-xl-3">
                       <div className="card">
                         <div className="card-body">
                           ...
                           <h4 className="project-title">
                             <Link to="/ProjevtView">Video Calling App</Link>
                           </h4>
                           <small className="block text-ellipsis m-b-15">
