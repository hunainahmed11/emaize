              ...
              <table className="table table-striped custom-table mb-0 datatable">
                ...
                <tbody>
                  <tr>
                    <td>1</td>
                    <td>
                      <Link to="/JobDetails">Web Developer</Link>
                    </td>
                    <td>Development</td>
                    <td>3 Mar 2019</td>
                    <td>31 May 2019</td>
                      ...
                      <div className="dropdown action-label">
                        ...
                        <div className="dropdown-menu dropdown-menu-right">
                          <a className="dropdown-item" href="#">
                            <i className="fa fa-dot-circle-o text-info" /> Full
                            Time
                          </a>
                          <a className="dropdown-item" href="#">
                  ...
                  <tr>
                    <td>2</td>
                    <td>
                      <Link to="/JobDetails">Web Designer</Link>
                    </td>
                    <td>Designing</td>
                    <td>3 Mar 2019</td>
                    <td>31 May 2019</td>
                  ...
                  <tr>
                    <td>3</td>
                    <td>
                      <Link to="/JobDetails">Android Developer</Link>
                    </td>
                    <td>Android</td>
                    <td>3 Mar 2019</td>
                    <td>31 May 2019</td>
