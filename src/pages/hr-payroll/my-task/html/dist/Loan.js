    ...
    <div className="main px-lg-4 px-md-4">
                ...
                <div className="card-body">
                  ...
                  >
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <span className="fw-bold">LP-0101</span>
                        </td>
                        <td className="d-flex align-items-center">
                          ...
                          <div>
                            ...
                            <span className="text-muted ms-1 d-block">
                        ...
                        <td>14 Jan, 2022</td>
                        <td>
                          <span className="text-danger fw-bold">$4000</span>
                        </td>
                        <td>
                          <div
                            className="btn-group"
                      ...
                      <tr>
                        <td>
                          <span className="fw-bold">LP-0102</span>
                        </td>
                        <td className="d-flex align-items-center">
                          <img
                            className="avatar rounded-circle"
                          ...
                          <div>
                            ...
                            <span className="text-muted ms-1 d-block">
                              Purpose : for home purchase, renovations and
                              refurbishing
                            </span>
                          </div>
                        </td>
                        <td>09 Feb, 2022</td>
                        <td>
                          <span className="text-danger fw-bold">$6000</span>
                        </td>
                        <td>
                          <div
                            className="btn-group"
                      ...
                      <tr>
                        <td>
                          <span className="fw-bold">LP-0103</span>
                        </td>
                        <td className="d-flex align-items-center">
                          <img
                            className="avatar rounded-circle"
                        ...
                        <td>17 Mar, 2022</td>
                        <td>
                          <span className="text-danger fw-bold">$6200</span>
                        </td>
                        <td>
                          <div
                            className="btn-group"
                      ...
                      <tr>
                        <td>
                          <span className="fw-bold">LP-0104</span>
                        </td>
                        <td className="d-flex align-items-center">
                          <img
                            className="avatar rounded-circle"
                        ...
                        <td>09 Apr, 2022</td>
                        <td>
                          <span className="text-danger fw-bold">$16000</span>
                        </td>
                        <td>
                          <div
                            className="btn-group"
                      ...
                      <tr>
                        <td>
                          <span className="fw-bold">LP-0105</span>
                        </td>
                        <td className="d-flex align-items-center">
                          <img
                            className="avatar rounded-circle"
                        ...
                        <td>09 Jun, 2022</td>
                        <td>
                          <span className="text-danger fw-bold">$10000</span>
                        </td>
                        <td>
                          <div
                            className="btn-group"
                      ...
                      <tr>
                        <td>
                          <span className="fw-bold">LP-0106</span>
                        </td>
                        <td className="d-flex align-items-center">
                          <img
                            className="avatar rounded-circle"
                        ...
                        <td>01 Oct, 2022</td>
                        <td>
                          <span className="text-danger fw-bold">$12000</span>
                        </td>
                        <td>
                          <div
                            className="btn-group"
              ...
              <div className="deadline-form">
                <form>
                  <div className="row g-3 mb-3">
                    ...
                    <div className="col-sm-12">
                      <label htmlFor="deponep" className="form-label">
                        Loan Purpose{" "}
                      </label>
                      <input
                        type="text"
      ...
      <div className="modal fade" id="depedit" tabIndex={-1} aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered modal-md modal-dialog-scrollable">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title  fw-bold" id="depeditLabel">
                {" "}
                Loan Edit
              </h5>
              <button
            ...
            <div className="modal-body">
              <div className="mb-3">
                <label
                  htmlFor="exampleFormControlInput11111"
                  className="form-label"
                >
                  Employee Name
                </label>
                  ...
                  <div className="row g-3 mb-3">
                    <div className="col-sm-6">
                      ...
                      <input
                        type="text"
                        className="form-control"
                        id="exampleFormControlInput111111"
                        defaultValue="$4000"
                      />
                    </div>
                    <div className="col-sm-6">
                      <label htmlFor="deptwo48" className="form-label">
                        Date
                      </label>
                      <input
                        type="date"
                        className="form-control"
                        id="deptwo48"
                        defaultValue="2022-01-14"
                      />
                    </div>
                    <div className="col-sm-12">
                      <label htmlFor="deponepp" className="form-label">
                        Loan Purpose{" "}
                      </label>
                      <input
                        type="text"
                        className="form-control"
                        id="deponepp"
                        defaultValue="for weddings and family functions"
                      />
                    </div>
                  </div>
                </form>
